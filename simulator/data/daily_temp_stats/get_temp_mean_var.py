# Original data from CDS was of hourly 2m temperature in GRIB format.
# This script processes a GRIB file to extract daily mean and variance of 2-meter temperature
# from specified locations and saves the results to CSV files.
# Daily mean and variance used to stochastically simulate daily temeperature variations
